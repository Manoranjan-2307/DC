...
export default function Student3_1() {
  const studentId = '7376242IT201';
  const [complaints, setComplaints] = useState([]);
  // const [text, setText] = useState('');
  // const fullText = '  HELLO SANGEETH 👋';
  ...
  return (
    <div>
      ...
      <p style={{fontFamily: 'sans-serif', fontSize: '30px', color: '#5A6387', fontWeight: 500}}>Hello Sangeeth ✨</p>
      </div>
      <div
