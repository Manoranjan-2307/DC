      ...
      <div style={{ marginTop: "40px" }}>
        <ul className="nav flex-column fs-5 mt-5">
          <div className="my-3 mx-1" style={{ fontFamily: "Tahoma" }}>
            <NavItem to="/student3_1" icon="bi-house" label="Home" collapsed={collapsed} location={location} />
          </div>
          <div className="my-3 mx-1" style={{ fontFamily: "Tahoma" }}>
            <NavItem to="/student3_2" icon="bi-clock-history" label="History" collapsed={collapsed} location={location} />
          </div>
          <div className="my-3 mx-1" style={{ fontFamily: "Tahoma" }}>
            <NavItem to="/student3_3" icon="bi-calendar" label="Schedules" collapsed={collapsed} location={location} />
          </div>
          <div className="my-3 mx-1" style={{ fontFamily: "Tahoma" }}>
            <NavItem to="/student3_4" icon="bi-file-earmark" label="Documents" collapsed={collapsed} location={location} />
          </div>
          <div className="my-3 mx-1" style={{ fontFamily: "Tahoma" }}>
